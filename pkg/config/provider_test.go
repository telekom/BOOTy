...
func TestValidate(t *testing.T) {
	tests := []struct {
		...
		{name: "network persistence accepts rhel bond", cfg: Config{PersistNetwork: true, OSFamily: "rhel", Network: NetworkConfig{Static: StaticConfig{IP: "10.1.0.5/24"}, Bond: BondConfig{Interfaces: "eth0,eth1"}}}},
