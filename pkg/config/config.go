...
type Config struct {
	...
	// OSFamily primarily selects the target OS network writer when
	// PersistNetwork is set. Provisioning preflight also uses it to reject
	// explicitly unsupported target families before destructive storage steps.
