...
type Config struct {
	...
	UnderlayDummyName string // Netplan underlay dummy name; empty uses "dummy.underlay"
	VXLANLink         string // Netplan VXLAN underlay link; empty leaves kernel selection
