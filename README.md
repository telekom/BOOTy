...
- **Declarative partition layouts** — GPT partition + optional LVM layout via `PARTITION_LAYOUT` JSON
...
| `PARTITION_LAYOUT` | — | Optional JSON layout (single-quoted in shell) for GPT partitions and LVM |
