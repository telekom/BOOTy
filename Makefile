...
booty-dhcpd-test-image:
	@printf '%s\n' 'Building DHCP server test image'
	@docker build -t booty-dhcpd-test:latest -f test/e2e/clab/dhcpd-test.Dockerfile test/e2e/clab

clab-dhcp-up: booty-dhcpd-test-image
